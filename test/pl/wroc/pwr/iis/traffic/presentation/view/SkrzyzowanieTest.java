...
//          }
    ...
    private void createDroga() {
        ...
        this.drogaView.addOstatniPunkt(20,30);
        this.drogaView.addOstatniPunkt(520,30);
	...
	public static void main(String[] args) {
		...
		SkrzyzowanieTest thisClass = new SkrzyzowanieTest();
	...
	private void createSShell() {
		...
		createCanva();
		sShell.setSize(new Point(562, 100));
